...
vec4 operator*(const mat4& m, const vec4& v) {
	return vec4(
		M4VD(0, v.x, v.y, v.z, v.w),
		M4VD(1, v.x, v.y, v.z, v.w),
		M4VD(2, v.x, v.y, v.z, v.w),
		M4VD(3, v.x, v.y, v.z, v.w)
	);
}

vec3 transformVector(const mat4& m, const vec3& v) {
	return vec3(
		M4VD(0, v.x, v.y, v.z, 0.0f),
		M4VD(1, v.x, v.y, v.z, 0.0f),
		M4VD(2, v.x, v.y, v.z, 0.0f)
	);
}

vec3 transformPoint(const mat4& m, const vec3& v) {
	return vec3(
		M4VD(0, v.x, v.y, v.z, 1.0f),
		M4VD(1, v.x, v.y, v.z, 1.0f),
		M4VD(2, v.x, v.y, v.z, 1.0f)
	);
}
...
vec3 transformPoint(const mat4& m, const vec3& v, float& w) {
	...
	w = M4VD(3, v.x, v.y, v.z, _w);

	return vec3(
		M4VD(0, v.x, v.y, v.z, _w),
		M4VD(1, v.x, v.y, v.z, _w),
		M4VD(2, v.x, v.y, v.z, _w)
	);
}
