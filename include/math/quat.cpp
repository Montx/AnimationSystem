...
bool operator==(const quat& left, const quat& right) {
	return (fabsf(left.x - right.x) <= kEpsilon && fabsf(left.y - right.y) <= kEpsilon && fabsf(left.z - right.z) <= kEpsilon && fabsf(left.w - left.w) <= kEpsilon);
}
...
bool sameOrientation(const quat& left, const quat& right) {
	return (fabsf(left.x - right.x) <= kEpsilon && fabsf(left.y - right.y) <= kEpsilon && fabsf(left.z - right.z) <= kEpsilon && fabsf(left.w - left.w) <= kEpsilon)
		|| (fabsf(left.x + right.x) <= kEpsilon && fabsf(left.y + right.y) <= kEpsilon && fabsf(left.z + right.z) <= kEpsilon && fabsf(left.w + left.w) <= kEpsilon);
}
